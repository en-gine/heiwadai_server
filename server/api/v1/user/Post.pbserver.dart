...
abstract class PostControllerServiceBase extends $pb.GeneratedService {
  $async.Future<$13.PostResponse> getPostByID($pb.ServerContext ctx, $13.PostRequest request);
  $async.Future<$13.PostsResponse> getPosts($pb.ServerContext ctx, $1.Empty request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetPostByID': return $13.PostRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      case 'GetPostByID': return this.getPostByID(ctx, request as $13.PostRequest);
