...
abstract class StoreControllerServiceBase extends $pb.GeneratedService {
  $async.Future<$3.Store> getByID($pb.ServerContext ctx, $15.SoreIDRequest request);
  $async.Future<$3.Stores> getAll($pb.ServerContext ctx, $1.Empty request);
  $async.Future<$3.StayableStores> getStayables($pb.ServerContext ctx, $1.Empty request);
  $async.Future<$3.StayableStore> getStayableByID($pb.ServerContext ctx, $15.SoreIDRequest request);

  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'GetByID': return $15.SoreIDRequest();
      case 'GetAll': return $1.Empty();
      case 'GetStayables': return $1.Empty();
      case 'GetStayableByID': return $15.SoreIDRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      case 'GetByID': return this.getByID(ctx, request as $15.SoreIDRequest);
      case 'GetAll': return this.getAll(ctx, request as $1.Empty);
      case 'GetStayables': return this.getStayables(ctx, request as $1.Empty);
      case 'GetStayableByID': return this.getStayableByID(ctx, request as $15.SoreIDRequest);
      default: throw $core.ArgumentError('Unknown method: $method');
    }
  }
