...
func (o *UserBook) GetBookPlan() *BookPlan {
	if o == nil {
		return nil
	}

	return o.R.GetBookPlan()
}
...
func (o *UserBook) GetBookUser() *UserDatum {
	if o == nil {
		return nil
	}

	return o.R.GetBookUser()
}
...
func (o *UserBook) GetGuestDatum() *BookGuestDatum {
	if o == nil {
		return nil
	}

	return o.R.GetGuestDatum()
}
...
func (userBookL) LoadGuestDatum(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserBook interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args[object.GuestDataID] = struct{}{}
	...
	query := NewQuery(
		...
		qm.WhereIn(`book_guest_data.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *UserBook) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(userBookPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert user_book, could not build conflict column list")
			}

			conflict = make([]string, len(userBookPrimaryKeyColumns))
			copy(conflict, userBookPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"user_book\"", updateOnConflict, ret, update, conflict, insert, opts...)
