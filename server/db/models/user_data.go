...
var UserDatumWhere = struct {
	...
	Prefecture:    whereHelpernull_Int{field: "\"user_data\".\"prefecture\""},
...
func (o *UserDatum) GetUser() *UserManager {
	if o == nil {
		return nil
	}
...
func (o *UserDatum) GetUserUserOption() *UserOption {
	if o == nil {
		return nil
	}

	return o.R.GetUserUserOption()
}
...
func (o *UserDatum) GetUserCheckins() CheckinSlice {
	if o == nil {
		return nil
	}

	return o.R.GetUserCheckins()
}
...
func (o *UserDatum) GetUserCouponAttachedUsers() CouponAttachedUserSlice {
	if o == nil {
		return nil
	}

	return o.R.GetUserCouponAttachedUsers()
}
...
func (o *UserDatum) GetUserMailMagazineLogs() MailMagazineLogSlice {
	if o == nil {
		return nil
	}

	return o.R.GetUserMailMagazineLogs()
}
...
func (o *UserDatum) GetBookUserUserBooks() UserBookSlice {
	if o == nil {
		return nil
	}

	return o.R.GetBookUserUserBooks()
}
...
func (o *UserDatum) GetUserUserReports() UserReportSlice {
	if o == nil {
		return nil
	}

	return o.R.GetUserUserReports()
}
...
var (
	...
	userDatumColumnsWithoutDefault = []string{"user_id", "first_name", "last_name", "first_name_kana", "last_name_kana", "accept_mail"}
	userDatumColumnsWithDefault    = []string{"company_name", "birth_date", "zip_code", "prefecture", "city", "address", "tel", "create_at", "update_at"}
...
func (userDatumL) LoadUserUserOption(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserDatum interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`user_option`),
		qm.WhereIn(`user_option.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userDatumL) LoadUserCheckins(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserDatum interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`checkin`),
		qm.WhereIn(`checkin.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userDatumL) LoadUserCouponAttachedUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserDatum interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`coupon_attached_user.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userDatumL) LoadUserMailMagazineLogs(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserDatum interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`mail_magazine_log.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userDatumL) LoadBookUserUserBooks(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserDatum interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`user_book`),
		qm.WhereIn(`user_book.book_user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userDatumL) LoadUserUserReports(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUserDatum interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`user_report`),
		qm.WhereIn(`user_report.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *UserDatum) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(userDatumAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(userDatumPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert user_data, could not build conflict column list")
			}

			conflict = make([]string, len(userDatumPrimaryKeyColumns))
			copy(conflict, userDatumPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"user_data\"", updateOnConflict, ret, update, conflict, insert, opts...)
