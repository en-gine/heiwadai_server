...
func (u *UserRegisterController) Call(ctx context.Context, req *connect.Request[userv1.UserRegisterRequest]) (*connect.Response[userv1.UserRegisterResponse], error) {
	msg := req.Msg
